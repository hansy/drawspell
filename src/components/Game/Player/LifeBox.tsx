...
export const LifeBox: React.FC<LifeBoxProps> = ({ player, isMe, className, opponentColors }) => {
        ...
        <div className={cn(
            ...
            <div className="flex gap-3 mt-1">
                {Object.entries(opponentColors).map(([opponentId, color]) => {
                    ...
                    return (
                        <div key={opponentId} className="flex flex-col items-center gap-0.5 group/cmd">
