...
const MOUSE_CONTROLS = [
    {
        id: "mouse.activateCard",
        title: "Activate Card",
        description: "Tap or untap a battlefield card; select or deselect a card in hand or a zone viewer.",
        gesture: "Click",
    },
    {
        id: "mouse.previewCard",
        title: "Preview Card",
        description: "Open and lock a card preview.",
        gesture: "Double click",
    },
    {
        id: "mouse.moveCard",
        title: "Move Card",
        description: "Drag a card to reposition or move it. A library's top card stays hidden until dropped.",
        gesture: "Drag",
    },
    {
    ...
    {
        id: "mouse.adjustMana",
        title: "Adjust Floating Mana",
        description: "Hover a mana orb to reveal its controls. Clear removes all floating mana.",
        gesture: "Hover",
    },
] as const;
...
const TOUCH_CONTROLS = [
    ...
    },
    {
        ...
        title: "Tap / Untap Battlefield Card",
        description: "Toggle a battlefield card's tapped state.",
        gesture: "Tap",
    },
    {
        id: "touch.selectCards",
        title: "Select Cards",
        description: "Select or deselect cards in hand or a zone viewer for group actions.",
        gesture: "Tap",
    },
    {
        id: "touch.previewCard",
        title: "Preview Card",
        description: "Open and lock a card preview.",
        gesture: "Double tap",
    },
    ...
    },
    {
        id: "touch.adjustMana",
        title: "Adjust Floating Mana",
        description: "Tap an orb, then use -/+. Tap elsewhere to close; Clear removes all floating mana.",
        gesture: "Tap orb",
    },
    {
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent">
                    <div className="hidden lg:flex lg:flex-col lg:gap-4">
                        <section aria-labelledby="mouse-controls-heading">
                            <h3
                                id="mouse-controls-heading"
                                className="px-3 pb-1 pt-2 text-[11px] font-semibold uppercase tracking-wider text-zinc-500"
                            >
                                Mouse Controls
                            </h3>
                            <div className="space-y-1">
                                {MOUSE_CONTROLS.map((control) => (
                                    <div
                                        key={control.id}
                                        className="flex items-center justify-between gap-3 rounded-lg border border-transparent p-3 transition-colors hover:border-zinc-800 hover:bg-zinc-900/40"
                                    >
                                        ...
                                        <div className="shrink-0 whitespace-nowrap rounded border-b-4 border-zinc-400 bg-zinc-200 px-2.5 py-1.5 font-mono text-[11px] font-semibold text-zinc-900 shadow-sm">
                                            {control.gesture}
                                        </div>
                                    </div>
                                ))}
                        ...
                        <section aria-labelledby="keyboard-shortcuts-heading">
                            <h3
                                ...
                                className="px-3 pb-1 text-[11px] font-semibold uppercase tracking-wider text-zinc-500"
                            >
                                Keyboard Shortcuts
                            </h3>
                            <div className="space-y-1">
